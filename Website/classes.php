...
<div id="card">
    ...
    <div class="card" id="ml">
        <img src="https://miro.medium.com/max/1400/0*QYxNNYh6W9jO1b_-.png" alt="Unity" height=auto class="card-img-top" style="width: 60% !important; align-self: center;">
        <div class="card-body d-flex flex-column">
            <h1 class="card-title">Intro to Machine Learning</h1>
            <p class="card-text">$8 per class. $40 for the whole course</p>
            <p class="card-text">Learn the fundamentals of Machine Learning!</p>
            <a class="btn btn-primary mt-auto btn-view" id="mlBtn" href="#mlModal">View more information</a>
        </div>
    </div>
...
<!--            <a class="btn btn-primary mt-auto btn-view"  id="codingBtn" href="#codingModal">View more information</a>-->
<!--        </div>-->
<!--    </div>-->
...
<!--            <a class="btn btn-primary mt-auto btn-view" id="ue4Btn" href="#ue4Modal">View more information</a>-->
<!--        </div>-->
<!--    </div>-->
...
<!--            <a class="btn btn-primary mt-auto btn-view"  id="flaskBtn" href="#flaskModal">View more information</a>-->
<!--        </div>-->
<!--    </div>-->
...
<!--            <a class="btn btn-primary mt-auto btn-view"  id="djangoBtn" href="#djangoModal">View more information</a>-->
<!--        </div>-->
<!--    </div>-->
...
<!--            <a class="btn btn-primary mt-auto btn-view" id="phpBtn" href="#phpModal">View more information</a>-->
<!--        </div>-->
<!--    </div>-->
<!--</div>-->
<!--<br>-->
<div id="card">
    ...
    <div class="card" id="c">
        <img src="https://www.britefish.net/wp-content/uploads/2019/07/logo-c-1.png" alt="C" height=auto class="card-img-top" style="width: 50% !important; align-self: center;">
        <div class="card-body d-flex flex-column">
            <h1 class="card-title">Programming in C</h1>
            <p class="card-text">$7 per class. $35 for the whole course</p>
            <p class="card-text">Learn how to code a variety of algorithms in C!</p>
            <a class="btn btn-primary mt-auto btn-view" id="cBtn" href="#cModal">View more information</a>
        </div>
    </div>
    ...
    <div class="card" id="invest">
        <img src="https://media.gq-magazine.co.uk/photos/5e25d00550c26e0008a9b030/master/pass/20200120-invest.jpg" alt="AP Physics 1" height=auto class="card-img-top" style="width: 50% !important; align-self: center; border-radius: inherit">
        <div class="card-body d-flex flex-column">
            <h1 class="card-title">Investment Essentials</h1>
            <p class="card-text">$7 per class. $35 for the whole course</p>
            <p class="card-text">Learn about different assets and investment strategies to increase wealth!</p>
            <a class="btn btn-primary mt-auto btn-view" id="investBtn" href="#investModal">View more information</a>
        </div>
    </div>
</div>
...
<div id="mlModal" class="modal">
    <div class="modal-content">
        <span class="close">&times;</span>
        <p>This class will introduce machine learning, its key concepts, and the wide variety of applications that it is used for.
            We will discuss the differences between ML, AI, and deep learning and explain what each is. Students
            will learn about the different types of machine learning models and we will dive into the intuition behind
            these models. We will compare and contrast these models with one another and determine which ones are the best for
            a specific purpose.</p>
        <p>By the end of this course, students will learn the fundamentals of machine learning.
        They will be familiar with different models and will have a thorough understanding of them so that they can
        start coding with ease when ready. We will be introducing a course that will begin coding with students
        soon!</p>
...
<div id="cModal" class="modal">
    <div class="modal-content">
        <span class="close">&times;</span>
        <p>In <b>Computer Programming in C</b>, students will learn about the different uses of C and its syntax.
            They will create a variety of projects in the target language of varying difficulties. By the end of the
            course, students should be comfortable creating their own programs independently in C!</p>
        <p><b>Age Requirements: </b>4th Grade and up</p>
        <p><b>Prerequisites: </b>To know some or little coding.</p>
        <p><b>Requirements:</b> A computer that can open a web browser.</p>
        <p><b>Timings: </b>TBD</p>
        <a class="btn btn-outline-primary" href="/signup" role="button">Sign Up Now!</a>
    </div>
</div>
