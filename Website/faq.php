...
<section id="faq" class="faq">
    <div class="container">
        <div style="background: linear-gradient(-45deg, #ddecff 50%, #ffffff 50%)">
            <h1 class="display-3 fw-bold text-uppercase" style="text-align: center; padding-top: 50px; padding-bottom: 50px; font-size: 60px; text-decoration: underline; text-decoration-color: #007bff;">faq</h1>
        </div>
        <br>
...
<br>
<h2 style="text-align: center;"><b>Ask us a question</b> - Visit <a target="_blank" href="https://forms.office.com/Pages/ResponsePage.aspx?id=isDjhI1WBUaKLG_rjQwJoXVRRTPodnNPux8MOe4nzhRUMkVSMDVBREtOMDA0N0lZMkFSUE5TVVVESC4u">this</a> link to ask us a question</h2>
<br>
</body>
